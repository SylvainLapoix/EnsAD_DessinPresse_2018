...
- La visualisation de la donnée consiste donc en un .red[**encodage**], c'est-à-dire une "conversion" d'un format à un autre.
...
Le sens peut aussi passer par d'autres sens que la vue.
